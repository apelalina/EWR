...
def error_pi(calculated_pi: Decimal) -> (Decimal):
    ...
    fehler = Decimal(pi) * Decimal('1') - calculated_pi
...
def pi_montecarlo(num_points) -> Decimal:
    ...
    pi_approx = (inside_circle * Decimal('1')) / (num_points * Decimal('1')) * Decimal('4')
